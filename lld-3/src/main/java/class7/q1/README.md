### Q1. Design a class diagram for BookMyShow
...
7. Every show will be for a movie and will have a start
   time and end time.
...
11. Users should be able to book multiple seats for a show via the app by paying for them at the time of
    booking.
