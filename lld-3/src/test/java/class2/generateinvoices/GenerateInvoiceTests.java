package class2.generateinvoices;

import class2.generateinvoices.controllers.BookingController;
...
import class2.generateinvoices.models.*;
import class2.generateinvoices.repositories.BookingRepository;
import class2.generateinvoices.repositories.CustomerSessionRepository;
...
class GenerateInvoiceTests {
    ...
    public void testGenerateInvoiceSuccess1() {
        ...
        Assertions.assertEquals(responseDto.getResponseStatus(), ResponseStatus.SUCCESS, "Generate Invoice should be SUCCESS");
        Assertions.assertNotNull(responseDto.getInvoice(), "Invoice should not be NULL");

        Invoice invoice = responseDto.getInvoice();
        Assertions.assertEquals(2, invoice.getBookedRooms().size(), "Invoice should have 2 rooms");
        ...
        Assertions.assertEquals(totalAmount * 1.28, invoice.getTotalAmount(), 0.1, "Total amount should be correct");
        Assertions.assertEquals(totalAmount * 0.18, invoice.getGst(), 0.1, "GST should be correct");
        Assertions.assertEquals(totalAmount * 0.1, invoice.getServiceCharge(), 0.1, "Service charge should be correct");
    }
    ...
    public void testGenerateInvoiceSuccess2() {
        ...
        Invoice invoice = responseDto.getInvoice();
        Assertions.assertEquals(4, invoice.getBookedRooms().size(), "Invoice should have 4 rooms");
    ...
    public void testGenerateInvoiceForInvalidCustomerSession() {
        ...
        GenerateInvoiceResponseDto responseDto = bookingController.generateInvoice(requestDto);
        Assertions.assertEquals(ResponseStatus.FAILURE, responseDto.getResponseStatus(), "Generate Invoice should be FAILURE");
        Assertions.assertNull(responseDto.getInvoice(), "Invoice should be NULL");
    }
